...
## Project Structure
    ...
    ├── feature_logic_enric_39040  # Django project configurations
...
1. Clone this repo and `cd feature_logic_enric_39040`
...
2. Clone this repo and `cd feature_logic_enric_39040`
